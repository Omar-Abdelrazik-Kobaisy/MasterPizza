...
//MARK: PRIVATE ITEMS OWNS BY VIEWMODEL
    ...
    var products : BehaviorRelay<[Product]> = BehaviorRelay(value: [Product(title:"Tropical Storm",desc: "Cheesy mayo sauce and mozzarella tomatoms , green pepper , onion" , rating: 2),Product(title:"Ocean Delight",desc: "squid , clams, crab stick ,Cheesy mayo sauce and mozzarella tomatoms , green pepper , onion" , rating: 3),Product(title:"Hawaiian paradise",desc: "Cheesy mayo sauce and mozzarella tomatoms , green pepper , onion" , rating: 5),Product(title:"Ocean Delight",desc: "squid , clams, crab stick ,Cheesy mayo sauce and mozzarella tomatoms , green pepper , onion" , rating: 3)])
